          ...
          const extrudeSettings: ExtrudeGeometryOptions = {
            ...
            UVGenerator: {
              ...
              generateSideWallUV: (
                ...
                const a = getVec3(indexA);
                const b = getVec3(indexB);
                const c = getVec3(indexC);

                const wallWidth = a.distanceTo(b);
                const wallHeight = a.distanceTo(c);

                return [
                  new Vector2(0, 0),
                  new Vector2(wallWidth * repeatScale, 0),
                  new Vector2(
                    wallWidth * repeatScale,
                    wallHeight * repeatScale
                  ),
                  new Vector2(0, wallHeight * repeatScale),
                ];
              },
            },
          };
